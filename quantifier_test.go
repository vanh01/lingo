...
func TestPAll(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := lingo.AsEnumerable(tt.source).AsParallel().All(tt.args.p)
			if got != tt.want {
				t.Errorf("All() = %v, want %v", got, tt.want)
			}
		})
...
func TestPAny(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := lingo.AsEnumerable(tt.source).AsParallel().Any(tt.args.p)
			if got != tt.want {
				t.Errorf("Any() = %v, want %v", got, tt.want)
			}
		})
...
func TestPContains(t *testing.T) {
	type Student struct {
		Id    int
		Name  string
		Level int
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := lingo.AsEnumerable(tt.source).AsParallel().Contains(tt.args.value, tt.args.c)
			if got != tt.want {
				t.Errorf("Contains() = %v, want %v", got, tt.want)
			}
		})
